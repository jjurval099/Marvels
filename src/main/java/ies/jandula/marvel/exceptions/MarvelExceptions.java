package ies.jandula.marvel.exceptions;

import java.util.HashMap;
import java.util.Map;

public class MarvelExceptions extends Exception
{
	/** Atributo - Código */
	private int code ;
	 ...
	 */
	public MarvelExceptions(int code, String message)
	{
		super(message);		
		this.code    = code ;
	 ...
	 */
	public MarvelExceptions(int code, String message, Throwable exception)
	{
